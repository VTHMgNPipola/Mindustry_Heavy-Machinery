...
public enum Difficulty {
    easy(4f, 2f, 1f, new DestrutiveHeuristic(new Predicate<Block>() {
        @Override
        public boolean test(Block b) {
            return b instanceof Generator;
        }
    })), // EASY
    ...
    purge(0.25f, 0.01f, 0.25f, new DestrutiveHeuristic(new Predicate<Block>() {
        @Override
        public boolean test(Block b) {
    ...
    /**
     * Path finding heuristic for calculating tile costs.
     */
