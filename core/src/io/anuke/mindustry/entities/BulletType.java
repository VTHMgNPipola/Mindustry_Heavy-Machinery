...
public abstract class BulletType extends BaseBulletType<Bullet> {
    ...
    antimatter = new BulletType(0.5f, 10_000) {
        {
            lifetime = 1000f;
            hitsize = 30f;
        }
        ...
        public void draw(Bullet b) {
            ...
            Draw.rect("antimatterbullet", b.x, b.y, b.angle());
            Draw.reset();
        }

        public void update(Bullet b) {
            if (b.timer.get(0, 15)) {
                Effects.effect(Fx.laserSpark, b.x + Mathf.range(2), b.y + Mathf.range(2));
            }
        }
        ...
        public void hit(Bullet b, float hitx, float hity) {
            DamageArea.damage(!(b.owner instanceof Enemy), b.x, b.y, 200f, damage);
        }
    },
