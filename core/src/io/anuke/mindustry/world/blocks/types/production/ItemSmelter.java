...
public abstract class ItemSmelter extends Block implements Smelter {
    ...
    public ItemSmelter(String name) {
        super(name);
        update = true;
        solid = true;
    }
    ...
    public void update(Tile tile) {
        ...
        // Add fuel (that is supposed to be a item
    ...
    public boolean acceptItem(Item item, Tile tile, Tile source) {
        ...
        return (isInput && tile.entity.getItem(item) < capacity)
                || (item == fuel && tile.entity.getItem(fuel) < capacity);
    }
